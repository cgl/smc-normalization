...
%  background=shade-tb,
  ...
  % Eye Catcher
  {\includegraphics[height=6em]{figures/Bogazici_universitesi_Logosu.jpg}} % No eye catcher for this poster. If an eye catcher is present, the title is centered between eye-catcher and logo.
  % Title
  ...
  % University logo
  {\includegraphics[height=7em]{figures/Bogazici_universitesi_Logosu.jpg}
  }
