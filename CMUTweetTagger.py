...
def _call_runtagger_tokenize(tweets, run_tagger_cmd=RUN_TAGGER_CMD):
    ...
    pos_results = [pr.split('\t') for pr in pos_result]  # split parts of message by each carriage return
    return pos_results
